...
export const WovenLightHero = () => {
	...
	useEffect(() => {
		// Fonts (Playfair Display + Inter) are vendored locally via @font-face in
		// index.css, so the original runtime Google Fonts <link> injection is no
		// longer needed — this keeps the hero fully self-contained and offline-safe.
